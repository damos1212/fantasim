...
export const BUILDING_DEFS: BuildingDef[] = [
  ...
  { type: BuildingType.Warehouse, name: "Warehouse", size: [3, 2], minAge: AgeType.Bronze, cost: { [ResourceType.Wood]: 20, [ResourceType.Stone]: 8 } },
  { type: BuildingType.Cistern, name: "Cistern", size: [2, 2], minAge: AgeType.Stone, cost: { [ResourceType.Stone]: 12, [ResourceType.Clay]: 6 } },
  { type: BuildingType.Farm, name: "Farm", size: [3, 3], minAge: AgeType.Stone, cost: { [ResourceType.Wood]: 10 } },
  { type: BuildingType.Orchard, name: "Orchard", size: [3, 3], minAge: AgeType.Stone, cost: { [ResourceType.Wood]: 12 } },
  { type: BuildingType.LumberCamp, name: "Lumber Camp", size: [2, 2], minAge: AgeType.Stone, cost: { [ResourceType.Wood]: 12, [ResourceType.Stone]: 8 } },
  { type: BuildingType.Quarry, name: "Quarry", size: [2, 2], minAge: AgeType.Stone, cost: { [ResourceType.Wood]: 10, [ResourceType.Stone]: 4 } },
  { type: BuildingType.Mine, name: "Mine", size: [2, 2], minAge: AgeType.Bronze, cost: { [ResourceType.Wood]: 16, [ResourceType.Stone]: 10 } },
  { type: BuildingType.Workshop, name: "Workshop", size: [2, 2], minAge: AgeType.Bronze, cost: { [ResourceType.Wood]: 20, [ResourceType.Stone]: 8 } },
